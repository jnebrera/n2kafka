...
static const char MSE8_PROBING[] =
		...
		"\"dot11Status\":\"PROBING\","
		"\"guestUser\":false,"
		"\"MapInfo\":{\"mapHierarchyString\":\"SantaClara "
		"Convention>Hyatt>HSC-FL8\","
...
static const char MSE8_GEO_PROBING[] =
		...
		"\"entity\":\"WIRELESS_CLIENTS\","
		"\"deviceId\":\"cc:aa:aa:aa:aa:ab\","
		"\"mseUdi\":\"AIR-MSE-VA-K9:V01:AS1-vMSE-8-CAS_af9752da-b07c-"
		"11e4-88d6-000c29defead\","
		"\"floorRefId\":0,"
		...
		"\"guestUser\":false,"
		"\"MapInfo\":{"
		"\"mapHierarchyString\":\"Auditorio Nacional>Interior>Piso 1 / "
		"Balcones\","
...
static const char MSE8_ASSOC[] =
		...
		"\"guestUser\":false,"
		"\"MapInfo\":{"
		"\"mapHierarchyString\":\"SantaClara "
		"Convention>Hyatt>HSC-FL06\","
...
static void
checkMSE8Enrichment_no_overlap(struct mse_array *notifications_array) {
...
static void
checkMSE8DefaultEnrichment_miss(struct mse_array *notifications_array) {
	/* No database -> output == input */
	assert(notifications_array->size == 1);
	assert(notifications_array->data[0].string_size ==
	       strlen(notifications_array->data[0].string));
